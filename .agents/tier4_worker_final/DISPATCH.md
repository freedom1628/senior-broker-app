...
## Identity & Scope
- Working directory: C:\Users\freed\.gemini\antigravity\scratch\senior-broker-app\.agents\tier4_worker_final
...
1. **Scenario 1 - Stagnation Detection & Session Count Progression**:
   - Breakout setup enters on Day 0 with entry $100, stop $98 ($2.00 risk = 1.0R, 75 shares for $150 risk).
...
Verify with `npx tsx src/tests/runner.ts t4_stale_exit_discipline`.
